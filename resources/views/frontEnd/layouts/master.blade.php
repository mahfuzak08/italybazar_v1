...
<html lang="en">
    <head>
        ...
        <meta name="author" content="ABSoftBD" />
        ...
        @foreach($domain_verify as $verify)
        <meta name="{{ $verify->authorizer }}" content="{{ $verify->content }}" />
        @endforeach
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
                                <p>Copyright © {{ date('Y') }} {{$generalsetting->name}}. All rights reserved | <span style="color: white;">Website Designed by: <a href="https://www.absoft-bd.com"><span style="color: white;">ABSoftBD</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
